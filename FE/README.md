...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Yp1XjIbOAd)
...
```sh
npx nx serve business_int
```

To create a production bundle:

```sh
npx nx build business_int
```

To see all available targets to run for a project, run:

```sh
npx nx show project business_int
```
